...
- **[@charlietango/use-mouse-closest-edge](https://www.npmjs.com/package/@charlietango/use-mouse-closest-edge)** _([useMouseClosestEdge](packages\useMouseClosestEdge\src))_ - Get the closest edge within an element relative to the mouse position..
